...
When [Quarto was formally released](https://www.apreshill.com/blog/2022-04-we-dont-talk-about-quarto/) earlier this year, I knew it'd only be a matter of time until I felt the incessant need to transition my oft-neglected blog to this new framework.
...
theme_obj = await FileAttachment("../../themes/improper-prior-observable.json").json()
...
Plot.plot({
  ...
  marks: [
    Plot.dot(transpose(iris), {x: "Sepal.Length", y: "Sepal.Width", stroke: "Species"}),
  ]
})
```
